...
class TestSudokuSolver(unittest.TestCase):
    ...
    # testing a board with missing cell
    def test_board_with_one_cell_missing(self):
        board_with_one_missing = [
            [5, 3, 4, 6, 7, 8, 9, 1, 2],
            [6, 7, 2, 1, 9, 5, 3, 4, 8],
            [1, 9, 8, 3, 4, 2, 5, 6, 7],
            [8, 5, 9, 7, 6, 1, 4, 2, 3],
        ...
        self.assertEqual(solve_sudoku(board_with_one_missing), solution)
